 ...
 * Единый «глубокий» вывод main.LabWork и вспомогательные сборщики текста.
 */
public final class ResponseUtils {
    ...
    /**
     * Полное форматирование main.LabWork со всеми вложенными объектами.
     */
    public static String formatLabWorkDeep(LabWork lw) {
        if (lw == null) return "null";
        StringBuilder sb = new StringBuilder();
        sb.append("main.LabWork {\n");
    ...
    /**
     * Собрать блок из списка main.LabWork с «глубоким» форматированием.
     */
