 ...
 * Для каждой строки формируется вложенный main.Request с теми же login/password, что у внешнего.
...
public class ExecuteScript implements Command {
    ...
    /**
     * Сборка main.Request из одной строки скрипта.
     * Здесь поддержаны только команды БЕЗ main.LabWork-объекта.
    ...
    private static Request fromLine(String cmd, String arg, String login, String password) {
        ...
        switch (cmd) {
            ...
            // Команды, требующие main.LabWork — не поддерживаем в этом варианте:
