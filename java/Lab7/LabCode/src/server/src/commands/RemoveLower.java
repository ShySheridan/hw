...
/**
 * Удаляет все элементы, МЕНЬШЕ заданного, только для текущего пользователя.
...
public class RemoveLower implements Command {
    ...
    public RemoveLower(CollectionManager manager, LabWorkDao dao) {
    ...
    @Override
    public String getDescription() { return "удалить из коллекции элементы, меньшие заданного (только свои)"; }
