...
/**
 * Клиентская утилита для интерактивного ввода объекта main.LabWork, когда пользователь вводит команду в терминале
 */
public class InputManager {
    ...
    /**
     * Собирает main.LabWork, запрашивая поля у пользователя.
     */
